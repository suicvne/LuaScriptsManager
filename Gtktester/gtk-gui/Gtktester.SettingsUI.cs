...
namespace Gtktester
{
	public partial class SettingsUI
	{
		...
		private global::Gtk.Entry optUsernameEntry;
...
In addition, a stack trace and error message will be sent. This is done automatically and silently if this option is enabled.";
			...
			this.hbox4.Add (this.enableSilentBugReporting);
			global::Gtk.Box.BoxChild w12 = ((global::Gtk.Box.BoxChild)(this.hbox4 [this.enableSilentBugReporting]));
			w12.Position = 0;
			// Container child hbox4.Gtk.Box+BoxChild
			this.label2 = new global::Gtk.Label ();
			this.label2.TooltipMarkup = "A username (or real name) to attach alongside the bug report.\n\nYou do NOT need an" +
			" account anywhere to insert this value and it is completely optional.";
			this.label2.Name = "label2";
			this.label2.LabelProp = "Username: ";
			...
			w13.Fill = false;
			// Container child hbox4.Gtk.Box+BoxChild
			this.optUsernameEntry = new global::Gtk.Entry ();
			this.optUsernameEntry.CanFocus = true;
			this.optUsernameEntry.Name = "optUsernameEntry";
			this.optUsernameEntry.IsEditable = true;
			this.optUsernameEntry.InvisibleChar = '●';
			this.hbox4.Add (this.optUsernameEntry);
			global::Gtk.Box.BoxChild w14 = ((global::Gtk.Box.BoxChild)(this.hbox4 [this.optUsernameEntry]));
			w14.Position = 2;
			// Container child hbox4.Gtk.Box+BoxChild
			...
			this.resetDatabaseBtn.Image = w15;
			this.hbox4.Add (this.resetDatabaseBtn);
			global::Gtk.Box.BoxChild w16 = ((global::Gtk.Box.BoxChild)(this.hbox4 [this.resetDatabaseBtn]));
			w16.Position = 3;
			w16.Expand = false;
			w16.Fill = false;
			// Container child hbox4.Gtk.Box+BoxChild
			...
			this.button21.Image = w17;
			this.hbox4.Add (this.button21);
			global::Gtk.Box.BoxChild w18 = ((global::Gtk.Box.BoxChild)(this.hbox4 [this.button21]));
			w18.Position = 4;
			w18.Expand = false;
			w18.Fill = false;
			...
			this.enableSilentBugReporting.Toggled += new global::System.EventHandler (this.OnEnableSilentBugReportingToggled);
